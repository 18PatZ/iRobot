...
charucoDetector = aruco.CharucoDetector(board=CHARUCO_BOARD)
...
#     corners, ids, rejectedImgPoints = detector.detectMarkers(gray)
    ...
    charuco_corners, charuco_ids, corners, ids, = charucoDetector.detectBoard(image=gray)
...
#             board=CHARUCO_BOARD)
    ...
    if charuco_corners is not None and len(charuco_corners) >= min_corners:
        ...
        print("Not able to detect a charuco board in image: {}".format(iname), "" if charuco_corners is None else (f" (only {len(charuco_corners)}/{min_corners} corners found)"))
